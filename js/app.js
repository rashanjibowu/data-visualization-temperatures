...
$(document).ready(function() {
	...
	// get some data
	d3.csv("data/plotdata.csv", function(rawData) {
...
/**
 * Gets the years associated with the data
 ...
 * @return {void}
 */
function drawLines(canvas, years) {
...
/**
 * Transforms the data from the raw format into the format we need
...
function transform(data) {
	...
	// for each element in data, return 4 elements
	data.forEach(function(element, index, thisArray) {

		seasons.forEach(function(season) {

			var deviation = (element[season] == "NA") ? 0 : +element[season];
	...
	return transformed.sort(sortDescending);
}
